...
export function slackIntentPrompt(context = {}) {
  return [
    ...
    "For unsupported requests, briefly explain the specific part you cannot perform, answer any safe part of the question, and offer a useful next step tailored to the actual request. Do not simply reject the user.",
